========================================================================
    KONSOLENANWENDUNG: Stategenerator-Projektübersicht
========================================================================

Diese Stategenerator-Anwendung wurde vom Anwendungs-Assistenten
für Sie erstellt.  

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien,
aus denen Ihre Stategenerator–Anwendung besteht.


Stategenerator.vcproj
...
StdAfx.h, StdAfx.cpp
    ...
    mit dem Namen "Stategenerator.pch" und eine 
