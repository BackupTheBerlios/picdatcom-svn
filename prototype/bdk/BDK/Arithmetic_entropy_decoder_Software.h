...
#ifndef __ARITHMETIC_ENTROPY_DECODER_SOFTWARE_H__
#define __ARITHMETIC_ENTROPY_DECODER_SOFTWARE_H__
...
namespace BDK
{
	...
	class Arithmetic_entropy_decoder_Software : public Arithmetic_entropy_decoder{
	public:
	  Arithmetic_entropy_decoder_Software();
	protected:
	  virtual void decode();
	  virtual void bytein();
	public:
...
#endif // defined __ARITHMETIC_ENTROPY_DECODER_SOFTWARE_H__