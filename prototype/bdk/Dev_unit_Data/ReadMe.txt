========================================================================
    KONSOLENANWENDUNG: Dev_unit_Data-Projektübersicht
========================================================================

Diese Dev_unit_Data-Anwendung wurde vom Anwendungs-Assistenten
für Sie erstellt.  

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien,
aus denen Ihre Dev_unit_Data–Anwendung besteht.


Dev_unit_Data.vcproj
...
StdAfx.h, StdAfx.cpp
    ...
    mit dem Namen "Dev_unit_Data.pch" und eine 
